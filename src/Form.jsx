                    ...
                    <form onSubmit={handlesub} className="login-form mt-5">
                        <fieldset className="fieldset-row">
                            ...
                            <input type="text" name="username" className="form-input"
                                value={curval.username} onChange={inputval}>
                            </input>
                        </fieldset>
                        <fieldset className="fieldset-row">
                            <label className="input-label">Password</label>
                            <input type="password" name="password" className="form-input"
                                value={curval.password} onChange={inputval} />
                        </fieldset>
                        <fieldset className="fieldset-row mb-4">
                            <label className="input-label">Email</label>
                            <input type="email" name="email" className="form-input"
                                value={curval.email} onChange={inputval} />
                        </fieldset>
                        <button type='submit' className="submit-btn" onClick={handlesub}>submit
                        </button>
                    </form>
